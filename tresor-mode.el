;;; tresor-mode.el --- mode for reading the tresor french dictionary
...
;; This package provides the tresor mode.

;;; Code:

(defcustom tresor-mode-hook nil
  "Normal hook run when entering Tresor mode and many related modes."
  :type 'hook
  :group 'data)
